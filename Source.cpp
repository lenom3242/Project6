...
public:
	...
	Circle(int newradius=1, int newx=0, int newy=0) : p_centr(new Point(newx,newy))
	{
		radius = newradius;
	}
	~Circle()
...
public:
	...
	Man(string newfullname, int newage, Car *newvehicle)
	{
		fullname = newfullname;
		age = newage;
		vehicle = newvehicle;
